...
import 'package:mohamed_mekhemar/app/access_to_course/model/access_to_course_model.dart';
import 'package:mohamed_mekhemar/app/course_members/generate_pdf/save_file_mobile.dart';
import 'package:syncfusion_flutter_pdf/pdf.dart';

class GenerateAccessToCoursePDF {
  ...
  Future<void> generateReport(
    context,
    activityName,
    List<Viewed> seenList,
    List<NotViewed> unSeenList,
  ) async {
    late File file;
    ...
    await saveAndLaunchFile(bytes, 'AccessToCourse.pdf');
...
//Create PDF grid and return
  PdfGrid getGrid(
    ...
    headerRow.cells[2].stringFormat.textDirection =
        PdfTextDirection.rightToLeft;
    headerRow.cells[3].value = 'Last Access';
