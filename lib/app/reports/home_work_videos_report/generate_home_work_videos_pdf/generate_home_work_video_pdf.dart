...
import 'package:mohamed_mekhemar/app/reports/home_work_videos_report/model/home_work_videos_report_model.dart';
import 'package:syncfusion_flutter_pdf/pdf.dart';

import '../../../course_members/generate_pdf/save_file_mobile.dart';

class GenerateHomeWorkVideosReportPDF {
  ...
  Future<void> generateReport(
    ...
    await saveAndLaunchFile(bytes, 'homeWorkVideos.pdf');
  }
