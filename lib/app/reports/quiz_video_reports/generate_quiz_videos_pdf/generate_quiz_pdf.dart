...
import 'package:mohamed_mekhemar/app/reports/quiz_video_reports/model/quiz_video_report_model.dart';
import 'package:syncfusion_flutter_pdf/pdf.dart';

import '../../../course_members/generate_pdf/save_file_mobile.dart';

class GenerateQuizVideosReportPDF {
  ...
  Future<void> generateReport(
    ...
    await saveAndLaunchFile(bytes, 'quizVideos.pdf');
  }
