...
class GenerateLessonsReportPDF {
  ...
  Future<void> generateReport(seenList, activityName) async {
    ...
    await saveAndLaunchFile(bytes, 'lessons.pdf');
  }
...
//Create PDF grid and return
  PdfGrid getGrid(List<Seen> seenList) {
    //Create a PDF grid
    ...
    headerRow.cells[2].stringFormat.textDirection =
        PdfTextDirection.rightToLeft;
    headerRow.cells[3].value = 'Number of views';
    ...
    for (var i in seenList) {
      addStudent(i.userid, i.fullname, i.centername, i.number, i.state,
          i.lastseen, grid);
    }
