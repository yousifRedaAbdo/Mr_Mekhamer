...
import 'package:mohamed_mekhemar/app/edit_profile_from_teacher/view_model/edit_profile_view_from_teacher_view_model.dart';
...
class EditStudentProfileView extends StatelessWidget {
  String token;
  EditStudentProfileView(this.token);

  @override
  Widget build(BuildContext context) {
    
    var deviceSize = MediaQuery.of(context).size;
    return BaseView<EditStudentProfileViewModel>(
      onModelReady: (viewModel) {
        viewModel.getUserData(token: token);
      },
            ...
            child: SafeArea(
              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  centerTitle: true,
                  title: appBarTitle(tr('edit_student_prof')),
                ),
                    ...
                    : Padding(
                        ...
                        child: ListView(
                          children: [
                            ...
                            heightSpace(30),
                            MobileInputField(
                              hint: viewModel.mobileNumber2Controller.text == ''
                                  ? 'parent mobile'
                                  : viewModel.mobileNumber2Controller.text,
                              inputType: TextInputType.number,
                              controller: viewModel.mobileNumber2Controller,
                              icon: Icons.phone,
